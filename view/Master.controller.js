(function() {
	...
	jQuery.sap.require("com.yo.testapp.util.Formatter");
	jQuery.sap.require("com.yo.testapp.util.Grouper");

	sap.ui.controller("com.yo.testapp.view.Master", {
				...
				this._lineItemViewDialog = new sap.m.ViewSettingsDialog({
					...
					confirm: function(evt) {
						...
						if (mParams.groupItem) {
							...
							var vGroup = com.yo.testapp.util.Grouper[sPath];
