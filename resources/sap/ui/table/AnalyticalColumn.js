...
sap.ui.table.AnalyticalColumn.prototype.setGrouped=function(g){var p=this.getParent();var t=this;if(p&&p instanceof sap.ui.table.AnalyticalTable){if(g){p._aGroupedColumns.push(this.getId())}else{p._aGroupedColumns=jQuery.grep(p._aGroupedColumns,function(v){return v!=t.getId()})}}var r=this.setProperty("grouped",g);this._updateTableColumnDetails();this._updateTableAnalyticalInfo(true);return r};
